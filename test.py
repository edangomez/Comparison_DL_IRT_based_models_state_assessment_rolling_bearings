...
def main():
    ...
    if args.cnn == 'AlexNet':
        ...
        print(f'Testing EfficientNet version {args.eff_ver}')
    ...
    if args.pt == 'yes':
        ...
        state_dict = torch.load(f'/home/edgomez10/DL_for_bearing_state_assessment_IRT/Experiments_hybrid/fv_HyRS_vgg19/best_m_e.pt')
    ...
    print(f'confusion matrix for {args.dtype} is:{confusion_mx.reshape(16)}\n {confusion_mx}')
    ...
    # results.to_csv(os.path.join(save_path, f'metrics_{args.experiment_name}test.csv'))
